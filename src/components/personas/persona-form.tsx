  ...
  return (
    <div className="bg-white border border-hairline rounded-lg p-8 max-w-2xl space-y-6">
      <div className="flex items-center gap-4">
        ...
        <p className="text-fine text-ink-48">头像按名称自动生成（DESIGN.md 7.6）</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="grid gap-2">
          <label className="text-caption font-semibold text-ink-80">视角类型</label>
          <select
      ...
      <div className="grid gap-2">
        <label className="text-caption font-semibold text-ink-80">系统提示词 *（人格蒸馏产物，用于交流与质询）</label>
        <textarea
          value={form.systemPrompt}
          onChange={set("systemPrompt")}
          rows={8}
          className="bg-white border border-hairline rounded-sm px-3 py-2 text-body leading-[1.5] outline-none focus:border-primary resize-y"
        />
      </div>
