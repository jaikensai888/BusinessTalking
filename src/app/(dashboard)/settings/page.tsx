    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      <div className="mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lead font-semibold leading-[1.2] tracking-[-0.4px]">设置</h1>
            <p className="text-caption text-ink-48">配置大模型服务，填入 API Key 后即可运行配方</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="rounded-lg border border-hairline bg-white">
          <div className="flex items-center gap-2 border-b border-divider-soft px-6 py-4">
            ...
            <h2 className="text-caption font-semibold">模型服务</h2>
          </div>
          <div className="p-6">
            <LLMSettingsForm />
          </div>
        ...
        <div className="flex items-center gap-2 rounded-lg border border-hairline bg-pearl px-5 py-4">
          <ShieldCheck size={18} className="shrink-0 text-success" />
          <p className="text-fine leading-[1.6] text-ink-48">
